...
function DrawBublleChart() {
    ...
    var svg = d3.select("#cancer_bubble")
        ...
        .attr("class", "bubble");
    var data = [
        {"id": "AMLE", "key": 0,"value":0, "color":"#393b79", "name": "Acute Myeloid Leukemia", "genes": [], "values":[]},
        {"id": "BASA", "key": 1,"value":0, "color":"#5254a3","name": "Basal Cell Carcinoma", "genes": [], "values":[]},
        ...
        {"id": "CMLE", "key": 4,"value":0, "color":"#637939","name": "Chronic Myeloid Leukemia", "genes": [], "values":[]},
        {"id": "COLO", "key": 5,"value":0, "color":"#80934a","name": "Colorectal Cancer", "genes": [], "values":[]},
        {"id": "ENDO", "key": 6,"value":0, "color":"#b5cf6b","name": "Endometrial Cancer", "genes": [], "values":[]},
        {"id": "GLIO", "key": 7,"value":0, "color":"#cedb9c","name": "Glioma", "genes": [], "values":[]},
        {"id": "MELA", "key": 8,"value":0, "color":"#8c6d31","name": "Melanoma", "genes": [], "values":[]},
        {"id": "nSCLC", "key": 9,"value":0, "color":"#bd9e39","name": "Non-Small Cell Lung Cancer", "genes": [], "values":[]},
        {"id": "PROS", "key": 10,"value":0, "color":"#e7ba52","name": "Prostate Cancer", "genes": [], "values":[]},
        {"id": "PANC", "key": 11,"value":0, "color":"#E5CB94","name": "Pancreatic Cancer", "genes": [], "values":[]},
        {"id": "RENA", "key": 12,"value":0, "color":"#843c39","name": "Renal Cell Carcinoma", "genes": [], "values":[]},
        {"id": "SCLC", "key": 13,"value":0, "color":"#ad494a","name": "Small Cell Lung Cancer", "genes": [], "values":[]},
...
function Subpathways(){
    ...
    var svg = d3.select("#bubbleset")
        .append("svg")
        .attr("id", "svgsubpathway")
        .attr("width", diameter)
        .attr("height", 400)
        .attr("class", "subpathway");

    var tempdata =[];
    graph.nodes.forEach(function (d) {
        if(d.tag !=="map"){
            d.community.forEach(function (a) {
                var group = JSON.parse(JSON.stringify(d));
                group.community =a;
                tempdata.push(group)
            })
        }
    ...
    groups = groups.filter(function (d) {
        return parentdata.indexOf(d.key)==-1;
    });
    groups.forEach(function (d) {
        d.value = 30;
    })
    $('#pathways').children().remove();
    $.each(groups, function (i, item) {
        $('#pathways').append($('<option>', {
            value: item.key,
            text: item.key
        }));
        $('#pathways').multiselect('destroy');
        $('#pathways').multiselect({
    ...
    //
    // var nodes = bubble.nodes({children: groups}).filter(function (d) {
    //     return !d.children;
    // });
    //
    // //setup the chart
    ...
    //     .attr("text-anchor", "middle")
    //     .html(function (d) {
    //         return (d.key.substring(0, d.r / 3));
    //     })
    //     .style({
    //         "fill": "white",
    //         "font-family": "Helvetica Neue, Helvetica, Arial, san-serif",
...
function UpdateGenesNetwork() {
    ...
    var groups = [
        {"id": "AMLE", "key": 0, "color":"#393b79", "name": "Acute Myeloid Leukemia", "values": []},
        {"id": "BASA", "key": 1, "color":"#5254a3","name": "Basal Cell Carcinoma", "values": []},
        {"id": "BLAD", "key": 2, "color":"#6b6ecf","name": "Bladder Cancer", "values": []},
        {"id": "BRCA", "key": 3, "color":"#9c9ede","name": "Breast Cancer", "values": []},
        {"id": "CMLE", "key": 4, "color":"#637939","name": "Chronic Myeloid Leukemia", "values": []},
        {"id": "COLO", "key": 5, "color":"#80934a","name": "Colorectal Cancer", "values": []},
        {"id": "ENDO", "key": 6, "color":"#b5cf6b","name": "Endometrial Cancer", "values": []},
        {"id": "GLIO", "key": 7, "color":"#cedb9c","name": "Glioma", "values": []},
        {"id": "MELA", "key": 8, "color":"#8c6d31","name": "Melanoma", "values": []},
        {"id": "nSCLC", "key": 9, "color":"#bd9e39","name": "Non-Small Cell Lung Cancer", "values": []},
        {"id": "PROS", "key": 10, "color":"#e7ba52","name": "Prostate Cancer", "values": []},
        {"id": "PANC", "key": 11, "color":"#E5CB94","name": "Pancreatic Cancer", "values": []},
        {"id": "RENA", "key": 12, "color":"#843c39","name": "Renal Cell Carcinoma", "values": []},
        {"id": "SCLC", "key": 13, "color":"#ad494a","name": "Small Cell Lung Cancer", "values": []},
        {"id": "THYR", "key": 14, "color":"#CE616C","name": "Thyroid Cancer", "values": []}
    ]
...
//              g.selectAll("path.group").data(groups).enter().insert("path")
//                  .attr("class", "line")
//                 .attr("d", function (d) {
//                    return lineFunction(d.values.sort(compare));
//                 })
...
//                 .attr("fill", "none");
    ...
    function update_intersection(intersection) {
        ...
        var selectedtext = g.selectAll(".text");
        selectedlinks.style("opacity", function (d) {
            if (intersection.indexOf(d.source.id) >=0 && intersection.indexOf(d.target.id) >=01) return 0.09
        })
        selectednodes.style("opacity", function (d) {
    ...
    bubblechart.on("click", function (d, i) {
        ...
        // g.selectAll("path.line").data(groups).enter().append("path")
        //     .attr("class", "line")
        //     .attr("d", function (d) {
        ...
        var selectednodes = g.selectAll(".node");
        selectednodes.attr("size",function (d) {
            if(intersect.indexOf(d.id)>=0) return 500;
        })
